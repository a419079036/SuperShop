...
public class MainActivity extends AppCompatActivity implements View.OnClickListener, AdapterView.OnItemClickListener, CompoundButton.OnCheckedChangeListener
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mchecktotal= (CheckBox) findViewById(R.id.cb_tatol);
        ...
        if (listView != null) {
            ...
            mchecktotal.setOnCheckedChangeListener(this);
        }
    }
    ...
    {
        Log.e("自定义标签", "类名==MainActivity" + "方法名==onCheckedChanged=====:" + "");
            mAdapter.TatolChecked();
