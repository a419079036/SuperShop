...
public class CartListAdapter extends BaseAdapter {
    ...
    private boolean isTatolChecked;
    ...
    public  void  TatolChecked()
    {
        Log.e("自定义标签", "类名==CartListAdapter" + "方法名==TatolChecked=====:" + isTatolChecked);
       isTatolChecked=!isTatolChecked;
        notifyDataSetChanged();
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (isTatolChecked)
        {
            Log.e("自定义标签", "类名==CartListAdapter" + "方法名==getView=====:" + isTatolChecked);
